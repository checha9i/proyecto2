<%-- 
    Document   : usuarios
    Created on : Jul 14, 2016, 1:50:24 PM
    Author     : David
--%>
                        ...
                        <div class="col-lg-10 col-lg-offset-1 jumbotron">
                            ...
                            <div class="row">
                                <%
                                    ...
                                    try{
                                        File archivo = new File(path + File.separator + "usuarios.txt");
                                    ...
                                    String fileInputPath = path + File.separator + "usuarios.txt";
                                    String fileOutputPath = path + File.separator + "usuarios.jpg";
                                    String tParam = "-Tjpg";
                                    String tOParam = "-o";
                                    ...
                                    out.print("<img src=\"" + request.getContextPath() + File.separator + "uploads" + File.separator + "usuarios.jpg" + "\">");
                                %>
                            </div>
                        </div>
                    </div>
